    ...
    Private Sub BT_Salva_Click(sender As Object, e As EventArgs) Handles BT_Salva.Click
        ...
        Try
            Using TA As New ModPackDBDataSetTableAdapters.Setup_RivestTableAdapter
                ...
                TA.Update(TIPO, TX_BX.Text, TX_BY.Text, TX_CX.Text, TX_CY.Text, TX_FX.Text, TX_FY.Text, TX_TX.Text, TX_TY.Text, Note, TX_NB.Text, TX_NC.Text, TX_NF.Text, TX_NT.Text, VecchiaRiga.Id, VecchiaRiga.Tipo, VecchiaRiga._BX_, VecchiaRiga._BY_, VecchiaRiga._CX_, VecchiaRiga._CY_, VecchiaRiga._FX_, VecchiaRiga._FY_, VecchiaRiga._TX_, VecchiaRiga._TY_, VecchiaRiga.NB, VecchiaRiga.NC, VecchiaRiga.NF, VecchiaRiga.NT)
